...
const formSchema = z.object({
  ...
  vars: z.object({
    ...
    teamKillValueIncrease: z.number({ coerce: true }).optional(),
    ...
    idleBanRounds: z.number({ coerce: true }).optional(),
    ...
    ctfRoundTimeModifier: z.number({ coerce: true }).optional(),
    gunMasterWeaponsPreset: z.number({ coerce: true }).optional(),
    killRotation: z.boolean().optional(),
    maxSpectators: z.number({ coerce: true }).optional(),
    premiumStatus: z.boolean().optional(),
    roundWarmupTimeout: z.number({ coerce: true }).optional(),
