...
export type VU_Commands = {
  ...
  SetTeamTicketCount?: string, // Accepts two arguments: a team number and the number of tickets that team should have. For example, to set the tickets of team 1 to 120 you would execute the following command: SetTeamTicketCount 1 120
