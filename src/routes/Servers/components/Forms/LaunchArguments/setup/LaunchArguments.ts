...
export const LaunchArgumentDescriptions = {
  common: {
    gamepath: "[COMMON] Set custom Battlefield 3 installation directory.",
    perftrace: "[COMMON] Enable performance logging to perftrace-[server|client].csv",
    env: "[COMMON] Set Zeus environment. Defaults to prod.",
    updateBranch: "[COMMON] Set update branch. Defaults to whatever -env is set to.",
    tracedc: "[COMMON] Enable DataContainer Trace usage in VEXT and print any dangling DCs during level destuction.",
  ...
  server: {
    ...
    unlisted: "[SERVER] Hide server from server list. Join requires connect console command or vu join string.",
